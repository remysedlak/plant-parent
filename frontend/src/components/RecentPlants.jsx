...
return (
    <div className="max-w-sm text-center ">
        <h1 className="text-2xl my-2 font-normal text-center md:text-left">Recently Viewed Plants</h1>
       <div className="mt-4 flex flex-col md:flex-col gap-y-2 items-center">
        {response.slice(0,3).map((plant) => (
            <div
                key={plant.id}
                className="bg-yellow-50 w-full hover:bg-yellow-100 transition duration-100 ease-in-out p-2 rounded-lg text-left border-gray-400 border-1 "
            >
